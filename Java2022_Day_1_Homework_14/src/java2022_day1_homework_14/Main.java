...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Cumle Icindeki Kelimeleri Belirtilen Duruma Gore
		...
		// Cumle Icindeki Karakterin Hepsini Kucuk Harf Ile Yazdiriyoruz
		...
		// Cumle Icindeki Karakterin Hepsini Buyuk Harf Ile Yazdiriyoruz
